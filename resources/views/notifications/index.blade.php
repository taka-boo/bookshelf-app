                ...
                @else
                    <ul class="divide-y divide-gray-100">
                        @foreach($notifications as $notification)
                            ...
                            @endphp
                            <li
                                class="relative {{ $isUnread ? 'bg-blue-50/40' : 'bg-white' }} hover:bg-gray-50 transition-colors">
                                ...
                                <div class="px-6 py-4 flex items-start">
                                    ...
                                    <div class="flex-shrink-0">
                                        <span
                                            class="inline-flex h-10 w-10 items-center justify-center rounded-full {{ $style['iconBg'] }}">
                                            @if($style['icon'] === 'calendar')
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 {{ $style['iconColor'] }}"
                                    ...
                                    <div class="ml-4 flex-1 min-w-0">
                                        <div class="flex items-center space-x-2">
                                            @if($isUnread)
                                                <span
                                                    class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-red-100 text-red-700">未読</span>
                                            @endif
                                        ...
                                        <p class="mt-2 text-xs text-gray-400">{{ $notification->created_at->diffForHumans() }}
                                        </p>
                                    </div>
